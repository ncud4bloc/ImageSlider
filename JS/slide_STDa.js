var moveRt =function(){
    ...
    if($('.active').attr('id') == 'xf5'){
        ...
        /*$('#xf5').slideUp(1200);
        $('#xb29').slideDown(1200);*/
        $('#xf5').animate({width: 'hide'});
        $('#xf5').css({
            'display': 'none'
        });
        $('#xb29').animate({width: 'show'});
        ...
        $('#xb29').animate({width: 'hide'});
        $('#xb29').css({
            'display': 'none'
        });
        $('#xcobra').animate({width: 'show'});
        ...
        /*$('#xcobra').slideUp(1200);
        $('#xf18').slideDown(1200);*/
        $('#xcobra').animate({width: 'hide'});
        $('#xcobra').css({
            'display': 'none'
        });
        $('#xf18').animate({width: 'show'});
        ...
        /*$('#xf18').slideUp(1200);
        $('#xv22').slideDown(1200);*/ 
        $('#xf18').animate({width: 'hide'});
        $('#xf18').css({
            'display': 'none'
        });
        $('#xv22').animate({width: 'show'});
        ...
        /*$('#xv22').slideUp(1200);
        $('#xf5').slideDown(1200);*/
        $('#xv22').animate({width: 'hide'});
        $('#xv22').css({
            'display': 'none'
        });
        $('#xf5').animate({width: 'show'});
